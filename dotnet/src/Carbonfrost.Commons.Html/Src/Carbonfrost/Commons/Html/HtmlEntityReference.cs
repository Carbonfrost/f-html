...
namespace Carbonfrost.Commons.Html {
    ...
    public class HtmlEntityReference : HtmlNode {

        private string name;

        internal HtmlEntityReference(string name, Uri baseUri) : base(baseUri) {
            this.name = name;
        }

        public override HtmlNodeType NodeType {
            get { return HtmlNodeType.Entity; }
        }
